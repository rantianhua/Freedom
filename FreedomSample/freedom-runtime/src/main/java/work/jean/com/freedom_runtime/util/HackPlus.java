...
public class HackPlus {
    ...
    /** Use {@link HackPlus#setAssertionFailureHandler(AssertionFailureHandler) } to set the global handler */
    ...
    /** This is a simple demo for the common usage of {@link HackPlus} */
    ...
    private static class Demo {
        ...
        static class Hacks {
            ...
            static void defineAndVerify() {
                HackPlus.setAssertionFailureHandler(new AssertionFailureHandler() { @Override public void onAssertionFailure(final AssertionException failure) {
                    Log.w("Demo", "Partially incompatible: " + failure.getDebugInfo());
                    // Report the incompatibility silently.
                    //...
                }});
                Demo_ctor = HackPlus.into(Demo.class).constructor().withParam(int.class);
                Demo_methodThrows = HackPlus.into(Demo.class).method("methodThrows").returning(Void.class).throwing(InterruptedException.class, IOException.class).withoutParams();
                Demo_staticMethod = HackPlus.into(Demo.class).staticMethod("methodWith2Params").returning(boolean.class).withParams(int.class, String.class);
                Demo_mField = HackPlus.into(Demo.class).field("mField").ofType(boolean.class).fallbackTo(false);
                Demo_sField = HackPlus.into(Demo.class).staticField("sField").ofType(String.class);
            }

            static HackedMethod1<Demo, Void, Unchecked, Unchecked, Unchecked, Integer> Demo_ctor;
            static HackPlus.HackedMethod0<Void, Demo, InterruptedException, IOException, Unchecked> Demo_methodThrows;
            static HackPlus.HackedMethod2<Boolean, Void, Unchecked, Unchecked, Unchecked, Integer, String> Demo_staticMethod;
